...
{username=200005,password=123456,mobileLogin=true,app=true,imei=863064010142216}
                ...
                */
                ...
                OkGoHttpUtil.doPost(MainActivity.this,"http://47.94.90.205/a/login",params1,false,"",new BaseHttpCallbackListener<Element>(){
                    @Override
                    public void callbackSuccess(String url, Element element) {
                        super.callbackSuccess(url, element);
...
{username=200005,password=123456,mobileLogin=true,app=true,imei=863064010142216}
                ...
                */
                ...
                OkGoHttpUtil.doPost(MainActivity.this,"http://47.94.90.205/a/pay/app",params2,false,"",new BaseHttpCallbackListener<Element>(){
                    @Override
                    public void callbackSuccess(String url, Element element) {
                        super.callbackSuccess(url, element);
